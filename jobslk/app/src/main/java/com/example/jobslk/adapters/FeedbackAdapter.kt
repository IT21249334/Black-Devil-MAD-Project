...
import com.example.jobslk.models.FeedbackModel
    ...
    class FeedbackAdapter(private val feedbackList:ArrayList<FeedbackModel>):
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val itemView = LayoutInflater.from(parent.context).inflate(R.layout.activity_feedbacks, parent, false)
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            holder.FeedbackName.text = currentfeedback.name //this part confusion
        }
        ...
        class ViewHolder (itemView: View, clickListner: onItemClickListner) : RecyclerView.ViewHolder(itemView) {
            val FeedbackName : TextView = itemView.findViewById(R.id.dfeedback)
