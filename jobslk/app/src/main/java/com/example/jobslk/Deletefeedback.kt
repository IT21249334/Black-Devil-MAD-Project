...
class Deletefeedback : AppCompatActivity() {
    ...
    )
    {
        ...
        dname.setText(intent.getStringExtra("feedbackname").toString())
        dfeedback.setText(intent.getStringExtra("feedbackfeedback").toString())
        ...
        btnUpdateData.setOnClickListener{
            ...
            dname.text=dname.text.toString()
            dfeedback.text=dfeedback.text.toString()
